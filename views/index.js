...
if(pathnameArr[2] == "dynamicstore.html"){
    ...
    parentContainer.addEventListener('click', async (e)=>{
        ...
        if (e.target.className=='cart-btn-bottom' || e.target.className=='cart-bottom' || e.target.className=='cart-holder'){
            ...
            paginationCart.innerHTML = `<button class="current-page paginationCartBtn">1</button>
                                            <button class="paginationCartBtn">2</button>
                                            <button class="paginationCartBtn">3</button>`
...
//         }
//     }
//     for(let i=numIndex;i<url.length;i++){
//         let num = parseInt(url[i]);
//         if(num==NaN){
//             break;
//         }else{
//             pageNum+=url[i];
